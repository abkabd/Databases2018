...
ALTER TABLE Movie
    ADD CONSTRAINT movie_unique UNIQUE(title, year);
------------------2)

ALTER TABLE Reviewer
    ADD CONSTRAINT reviewer_pk PRIMARY KEY(rID);
------------------3)

ALTER TABLE Rating
    ADD CONSTRAINT rating_unique UNIQUE(rID,mID,ratingDate);
------------------4)
...
ALTER TABLE Movie
    ADD CONSTRAINT movie_check_year CHECK (year > 1900);
------------------7)

ALTER TABLE Rating
    ADD CONSTRAINT rating_stars CHECK (stars IN (1, 2, 3, 4, 5));
------------------8)

ALTER TABLE Rating
    ADD CONSTRAINT rating_check_year CHECK (ratingDate > '31-12-1999');
------------------9)

ALTER TABLE Movie
    ADD CONSTRAINT movie_director_check CHECK((director NOT IN ('Steven Spielberg', 'James Cameron'))
                                                       OR (director = 'Steven Spielberg' AND year < 1990)
